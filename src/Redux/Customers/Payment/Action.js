...
import {
  ...
  export const createPayment = (reqData) => async (dispatch) => {
    ...
    try {
      ...
      const { data } = await api.post(`${API_BASE_URL}/api/payments/${reqData.orderId}`,reqData, config);
  ...
  export const updatePayment = (reqData) => {
    return async (dispatch) => {
      ...
      try {
        ...
        const response = await api.get(`${API_BASE_URL}/api/payments?payment_id=${reqData.paymentId}&order_id=${reqData.orderId}`,config);
